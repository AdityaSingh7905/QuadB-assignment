...
const TaskChart = ({ tasks }: TaskChartProps) => {
  ...
  const data = [
    ...
    { name: "Pending", value: pendingTasks, color: "#2E6930" },
  ];

  return (
    <div className="bg-white dark:bg-[#2D3C2E] p-4 rounded-xl shadow-md w-full flex flex-col items-center border border-gray-200 dark:border-[#1D291E] mt-4">
